...
void difffunc_EC3_E_pyr(double x[], double dx[], STR_PARA *paras){  // Rotstein,et al., 2006, JCN,  Saravanan, 2015,Hipp, Middleton, 2008,PNAS
  ...
  static double gNa=100.0,gK=80.0,gL=0.5,gAHP=0.6,gh=0.0; //check point in old version, gh=0.25 (2017.6.30 update)   check point gahp=0.4->0.5
  static double VNa=50.0,VK=-90.0,VL=-65.0,VAHP=-100,Vh=-20;  //check
